const architectureDiagram = `
  <div class="diagram-shell">
    <svg viewBox="0 0 1560 560" style="width:100%;min-width:1280px;height:auto;">
      ...
      <rect x="14" y="14" rx="28" ry="28" width="1572" height="532" fill="#edf3f8" stroke="#d7e2ee"></rect>
      ...
      <!-- Foundation Model -->
      <g filter="url(#shadowSoft)">
        <rect x="1270" y="140" rx="22" ry="22" width="280" height="96" fill="url(#boxFill)" stroke="#b8c6d8" stroke-width="2"></rect>
