const architectureDiagram = `
  <div class="diagram-shell" style="padding:28px;background:linear-gradient(180deg,#eef3f8 0%,#f8fafc 100%);">
    <svg viewBox="0 0 1200 520" style="width:100%;min-width:1000px;height:auto;display:block;">
      ...
      <rect x="14" y="14" rx="30" ry="30" width="1172" height="492" fill="#edf3f8" stroke="#d7e2ee"></rect>
      ...
      <g filter="url(#shadowSoft)">
        <rect x="56" y="124" rx="24" ry="24" width="190" height="92" fill="url(#boxFill)" stroke="#b8c6d8" stroke-width="2"></rect>
      ...
      <!-- Application Layer -->
      <g filter="url(#shadowSoft)">
        <rect x="300" y="124" rx="24" ry="24" width="220" height="92" fill="url(#boxFill)" stroke="#b8c6d8" stroke-width="2"></rect>
      ...
      <g filter="url(#shadowSoft)">
        <rect x="574" y="124" rx="24" ry="24" width="282" height="92" fill="url(#boxFill)" stroke="#b8c6d8" stroke-width="2"></rect>
      ...
      <!-- Foundation Model -->
      <g filter="url(#shadowSoft)">
        <rect x="910" y="124" rx="24" ry="24" width="232" height="92" fill="url(#boxFill)" stroke="#b8c6d8" stroke-width="2"></rect>
      ...
      <!-- Lower row -->
      <g filter="url(#shadowSoft)">
        <rect x="250" y="286" rx="24" ry="24" width="280" height="102" fill="url(#boxFill)" stroke="#b8c6d8" stroke-width="2"></rect>
      ...
      <g filter="url(#shadowSoft)">
        <rect x="620" y="286" rx="24" ry="24" width="300" height="102" fill="url(#boxFill)" stroke="#b8c6d8" stroke-width="2"></rect>
      ...
      <!-- Supporting services -->
      <g filter="url(#shadowSoft)">
        <rect x="86" y="420" rx="24" ry="24" width="1028" height="68" fill="#f5f9fc" stroke="#d5e1ec"></rect>
      </g>
      ...
      <g filter="url(#shadowSoft)">
        <rect x="104" y="450" rx="18" ry="18" width="185" height="30" fill="#ffffff" stroke="#c7d4e2"></rect>
        <text x="196" y="470" text-anchor="middle" font-size="12" font-weight="700" fill="#334155">API Gateway / Lambda</text>
      </g>

      <g filter="url(#shadowSoft)">
        <rect x="318" y="450" rx="18" ry="18" width="180" height="30" fill="#ffffff" stroke="#c7d4e2"></rect>
        <text x="408" y="470" text-anchor="middle" font-size="12" font-weight="700" fill="#334155">Amazon SageMaker</text>
      </g>

      <g filter="url(#shadowSoft)">
        <rect x="528" y="450" rx="18" ry="18" width="170" height="30" fill="#ffffff" stroke="#c7d4e2"></rect>
        <text x="613" y="470" text-anchor="middle" font-size="12" font-weight="700" fill="#334155">AWS Trainium</text>
      </g>

      <g filter="url(#shadowSoft)">
        <rect x="724" y="450" rx="18" ry="18" width="170" height="30" fill="#ffffff" stroke="#c7d4e2"></rect>
        <text x="809" y="470" text-anchor="middle" font-size="12" font-weight="700" fill="#334155">AWS Inferentia</text>
      </g>

      <g filter="url(#shadowSoft)">
        <rect x="922" y="450" rx="18" ry="18" width="150" height="30" fill="#ffffff" stroke="#c7d4e2"></rect>
...
function initBlog() {
  if (!listEl || !categoryEl || !titleEl || !metaEl || !contentEl) {
    console.error("Blog container elements not found.");
    return;
  }
